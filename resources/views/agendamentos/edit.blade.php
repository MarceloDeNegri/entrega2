...
<div class="form-group">
        ...
        {!!Form::select('paciente_id',
         \App\Paciente::orderBy('nome')->pluck('nome', 'id')->toArray(),$agendamento->paciente_id,
        ['class'=>'form-control'])!!}
</div>
<div class="form-group">
    {!!Form::label('medico_id', 'Medico:')!!}
    {!!Form::select('medico_id',
     \App\Medico::orderBy('nome')->pluck('nome', 'id')->toArray(),$agendamento->medico_id,
    ['class'=>'form-control'])!!}
</div>
<div class="form-group">
    {!!Form::label('convenio_id', 'Convenio:')!!}
    {!!Form::select('convenio_id',
    \App\Convenio::orderBy('nome')->pluck('nome','id')->toArray(),$agendamento->convenio_id,
    ['class'=>'form-control'])!!}
</div>
        <div class="form-group">
